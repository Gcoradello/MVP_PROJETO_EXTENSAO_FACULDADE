...
user.observation = document.getElementById("obs-FO").value
...
document.getElementById("btn-fo-plus").addEventListener("click", function (){updateTacticalStatus("plus")});
document.getElementById("btn-fo-minus").addEventListener("click", function (){updateTacticalStatus("minus")});
